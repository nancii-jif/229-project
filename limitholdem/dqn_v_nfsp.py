...
def play_dqn(args):
    ...
    with Logger(args.log_dir) as logger:
        for episode in range(args.num_episodes):
            ...
            if episode % args.evaluate_every == 0:
                dqn_reward, nfsp_reward = tournament(
                    env,
                    args.num_eval_games,
                )
                dqn_rewards.append(dqn_reward)
                nfsp_rewards.append(nfsp_reward)
    ...
    save_path_nfsp = os.path.join(args.log_dir, 'model_nfsp.pth')
    torch.save(dqn_agent, save_path_dqn)
    torch.save(nfsp_agent, save_path_nfsp)
    print('DQN Model saved in', save_path_dqn)
    print('NFSP Model saved in', save_path_nfsp)
    ...
    fig_path = 'lhresults/dqn_nfsp_compete_result_nf/plot_nfsp_first.png'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--log_dir',
        type=str,
        default='lhresults/dqn_nfsp_compete_result_nf/',
    )
